    ...
    >
      ...
      >
        ...
        <div className="flex flex-row justify-between items-center w-full text-white">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[55px] text-[52px] text-white ss:leading-[80px] leading-[80px]">
            Hi there!
        ...
        <h1 className="font-poppins font-semibold ss:text-[55px] text-[52px] text-white ss:leading-[80px] leading-[80px] w-full">
